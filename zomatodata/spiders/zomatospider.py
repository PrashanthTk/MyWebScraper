...
class ZomatoSpider(Spider):
    ...
    start_urls = [
        'http://zomato.com/chennai/restaurants?page=1',
        #'http://zomato.com/bangalore/restaurants?page=1',
        #'http://www.zomato.com/mysore/restaurants?page=1',
        #'http://www.zomato.com/pune/restaurants?page=1',
        #'http://www.zomato.com/mumbai/restaurants?page=1',
        #'http://www.zomato.com/hyderabad/restaurants?page=1',
        #'http://www.zomato.com/kolkata/restaurants?page=1',
        #'http://www.zomato.com/ncr/restaurants?page=1',
    ]
    ...
    def parse_rest(self, response):
		...
		rest.add_xpath('cuisines','//div/a[contains(@title,"View all")]/text()')
		...
		rest.add_value('r_latitude', value=response.xpath("//script[contains(@type,\"text/javascript\")]/text()").re(r'var mapData\s*[=]\s*\{lat:\s*([0-9.]+),'))
		rest.add_value('r_longitude', value=response.xpath("//script[contains(@type,\"text/javascript\")]/text()").re(r'var mapData\s*[=]\s*\{lat:\s*[0-9.]+,\s*lon:\s*([0-9.]+)\}'))
